...
function feather_addons()
{
	...
	wp_register_style('feather-default-fonts' , 'http://fonts.googleapis.com/css?family=Ubuntu:400,300,700,400italic,900|Open+Sans:400,300,700|Voltaire');
    ...
    wp_register_style('feather-non-responsive' , get_template_directory_uri(). '/css/non-responsive.css');
    ...
    wp_register_style('feather-omega' , get_template_directory_uri() . '/css/omega.css');
    ...
    wp_enqueue_style('feather-non-responsive');
    wp_enqueue_style('feather-user-custom-styles');
    wp_enqueue_style('feather-omega');
