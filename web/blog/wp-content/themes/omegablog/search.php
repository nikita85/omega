            ...
            <div class="container">
                <div class="row">
                	...
                	<h2 class="main-page-title col-md-12" style="margin-bottom: 20px;"><?php 
                                        ...
                                        if(isset($feather_theme_options['search_title']) && $feather_theme_options['search_title'] != '') :
                                            echo str_replace('$' , $_GET['s'] ,$feather_theme_options['search_title']);
                                        else :
                                            echo __('Search Results For ' , 'dsf') . ' ' . $_GET['s'];
                                        endif;
                                        ?></h2>
