		               ...
		               case 'select' :
		                 ...
		                 case 'checkbox' :
		                    $out = '<div class="drop_meta_item">
	                                ...
	                                if(get_post_meta(get_the_ID() , $field['id'] , true) === 'on') $out .= ' checked=checked ';
	                                $out .= '>
		                            <div style="float: left; margin-left: 30%;" class="meta_description"><p>'.$field['desc'].'</p></div>
		                            </div><!-- end inner -->
		                            </div><!-- end single meta -->';
...
$post_fields = array(
                    ...
                    'fields' => array(
                    					array(
                                             'id' => 'ogg',
                                             'desc' => __('Insert HTML5 ogg audio file link.','dsf'),
                                             'name' => __('HTML5 Audio / Ogg','dsf'),
                                             'type' => 'text'
                                        ),
                                        array(
                                             'id' => 'mp3',
                                             'desc' => __('Insert HTML5 mp3 audio file link. .','dsf'),
                                             'name' => __('HTML5 Audio / Mp3','dsf'),
                                             'type' => 'text'
                                        ),
                                        array(
                                             'id' => 'video',
                                             'desc' => __('Paste your video code here for video post format .','dsf'),
                                             'name' => __('Embed Video','dsf'),
                                             'type' => 'textarea'
                                        ),
                                        array(
                                             'id' => 'audio',
                                             'desc' => __('Insert audio code here for audio post format','dsf'),
                                             'name' => __('Embed Audio','dsf'),
                                             'type' => 'textarea'
                                             ),
                                        array(
                                             'id' => 'link',
                                             'desc' => __('Paste you link here ,make sure link post format is selected .','dsf'),
                                             'name' => __('Link','dsf'),
                                             'type' => 'text'
                                        ),
                                        array(
                                             'id' => 'quote',
                                             'desc' => __('Add a quote post , select quote post format .','dsf'),
                                             'name' => __('Quote','dsf'),
                                             'type' => 'textarea'
                                        ),
                                        array(
                                             'id' => 'quote-author',
                                             'desc' => __('the quote author .','dsf'),
                                             'name' => __('Quote Author','dsf'),
                                             'type' => 'text'
                                        ), 
                                        array(
                                             'id' => 'quote-link',
                                             'desc' => __('check this box if you wish to link quote to the post .','dsf'),
                                             'name' => __('Quote Link','dsf'),
                                             'type' => 'checkbox'
                                        ),
                                        array(
                                             'id' => 'status',
                                             'desc' => __('Embed Status Here , Embed your facebook status or tweet heres .','dsf'),
                                             'name' => __('Embed Status','dsf'),
                                             'type' => 'textarea'
                                        ),
                                        array(
